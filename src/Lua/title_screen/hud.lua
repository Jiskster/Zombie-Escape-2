...
addHook("HUD", function(v)	
	...
	if title_tics >= title_timetoappear and title_tics <= (title_timetoappear+drawtics_frame1)
		local ze2logo1 = v.cachePatch("ZE2_TTL00")
		v.drawScaled(title_xoffset, title_yoffset, FU/4, ze2logo1)
	elseif title_tics >= (title_timetoappear+drawtics_frame1) and title_tics <= (title_timetoappear+drawtics_frame2)
		local ze2logo2 = v.cachePatch("ZE2_TTL01")
		v.drawScaled(title_xoffset, title_yoffset, FU/4, ze2logo2)
	elseif title_tics >= (title_timetoappear+drawtics_frame2) and title_tics <= (title_timetoappear+drawtics_frame3)
		local ze2logo3 = v.cachePatch("ZE2_TTL02")
		v.drawScaled(title_xoffset, title_yoffset, FU/4, ze2logo3)
	elseif title_tics >= (title_timetoappear+drawtics_frame3) and title_tics <= (title_timetoappear+drawtics_frame4)
		local ze2logo4 = v.cachePatch("ZE2_TTL03")
		v.drawScaled(title_xoffset, title_yoffset, FU/4, ze2logo4)
	elseif title_tics >= (title_timetoappear+drawtics_frame4)
